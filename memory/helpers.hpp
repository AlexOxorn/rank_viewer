...
template<typename type = int, std::convertible_to<u64> T> requires std::is_trivially_copyable_v<type>
...
template<typename type = int, int length = 3, std::convertible_to<u64> T> requires std::is_trivially_copyable_v<type>
